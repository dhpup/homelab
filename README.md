...
| [doplarr](https://github.com/activexray/doplarr_rs) v4.6.0 | Discord slash-command bot for requesting movies and TV shows via Seerr |
...
| [maintainerr](https://github.com/Maintainerr/Maintainerr) v3.25.0 | Rule-based media cleanup and rotation for Plex/Jellyfin libraries |
| [prowlarr](https://prowlarr.com/) v2.5.2 | Indexer manager — syncs indexers to Radarr and Sonarr |
| [radarr](https://radarr.video/) v6.4.2 | Movie library automation (root: `/homelab-storage/movies`) |
